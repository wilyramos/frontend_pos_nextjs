...
/** Shopping Cart */
const ShoppingCartContentsShema = ProductSchema.pick({
    name: true,
    image: true,
    price: true,
    inventory: true
...
export const ShoppingCartSchema = z.array(ShoppingCartContentsShema);
...
export type CartItem = z.infer<typeof ShoppingCartContentsShema>;
